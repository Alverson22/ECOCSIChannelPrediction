function [ReceivedPacket,h] = getOFDMChannel(TransmittedFrame,LengthCP,h,NoiseVar)
...
PhaseShift = exp(-1j*(AAngle(1:NumPacket)*2+DShift(1:NumPacket)*1e-2)*pi); % Phase Shift (inlcude Doppler effect)
...
save('ChannelNoise.mat','NoiseT','NumSC','LengthCP','NumSym','NumPacket');
